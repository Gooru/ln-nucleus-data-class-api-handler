...
public class QuestionsToGradeHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    if (StringUtil.isNullOrEmpty(courseId)) {
      ...
      return new ExecutionResult<>(MessageResponseFactory.createInvalidRequestResponse(
          "Course Id Missing. Cannot fetch Questions pending grading"), ExecutionStatus.FAILED);
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    List<Map> queMap =
        Base.findAll(AJEntityBaseReports.GET_QUESTIONS_TO_GRADE, this.classId, this.courseId);
    if (!queMap.isEmpty()) {
      queMap.forEach(m -> {
        ...
        AJEntityBaseReports sessionModel = AJEntityBaseReports.findFirst(
        ...
        if (sessionModel != null) {
          String latestSessionId = sessionModel.get(AJEntityBaseReports.SESSION_ID) != null
              ? sessionModel.get(AJEntityBaseReports.SESSION_ID).toString()
              : null;
          ...
          if (resourceStudentMap.containsKey(questionId)) {
            ...
            try {
              ...
              if ((pathId != null && pathId > 0)
                ...
                que = checkIfSystemSuggestExistsAndPopulateULCMetadata(que, pathId, pathType,
                    val.getString(AJEntityBaseReports.LESSON_GOORU_OID), collectionId);
              }
              ...
              que.put(AJEntityBaseReports.ATTR_COLLECTION_TYPE,
              ...
              LOGGER.info("QTGH::Exception while fetching rubric question meta:: {}",
                  e1.fillInStackTrace());
            }
  ...
  private JsonObject populateRoute0SuggestULCMetadata(JsonObject que, String collectionId)
      throws Throwable {
    ...
    que.put(JsonConstants.LESSON_TITLE,
    ...
    que.put(JsonConstants.UNIT_TITLE,
  ...
  private JsonObject checkIfSystemSuggestExistsAndPopulateULCMetadata(JsonObject que,
