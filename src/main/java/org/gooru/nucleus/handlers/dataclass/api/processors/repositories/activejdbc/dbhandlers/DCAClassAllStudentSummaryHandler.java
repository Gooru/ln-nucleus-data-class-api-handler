...
public class DCAClassAllStudentSummaryHandler implements DBHandler {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(DCAClassAllStudentSummaryHandler.class);
      ...
      if (context.request() == null || context.request().isEmpty()) {
        ...
        return new ExecutionResult<>(
            MessageResponseFactory.createInvalidRequestResponse(
                "Invalid data provided to fetch DCA Class All Students Summary report"),
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (collectionType.equalsIgnoreCase(JsonConstants.ASSESSMENT)) {
      ...
      monthlyAssessmentData =
          Base.findAll(AJEntityDailyClassActivity.DCA_CLASS_USER_USAGE_ASSESSMENT_DATA,
              context.classId(), context.collectionId(), year, month);
      monthlyAssessmentData.stream().forEach(monthAssessmentData -> {
        ...
        user.put(AJEntityBaseReports.ATTR_USER_ID,
            monthAssessmentData.get(AJEntityDailyClassActivity.GOORUUID).toString());
      ...
      monthlyCollectionData =
          Base.findAll(AJEntityDailyClassActivity.DCA_CLASS_USER_USAGE_COLLECTION_DATA,
              context.classId(), context.collectionId(), year, month);
      monthlyCollectionData.stream().forEach(monthCollectionData -> {
        ...
        user.put(AJEntityBaseReports.ATTR_USER_ID,
            monthCollectionData.get(AJEntityDailyClassActivity.GOORUUID).toString());
