	  ...
	  public ExecutionResult<MessageResponse> executeRequest() {
	    ...
	    if (classId.isEmpty()) {
	      ...
	      return new ExecutionResult<>(
	              MessageResponseFactory.createInvalidRequestResponse("ClassId is Missing. Cannot fetch Student Performance Vs Completion Data"),
	    ...
	    if (courseId.isEmpty()) {
		      ...
		      return new ExecutionResult<>(
		              MessageResponseFactory.createInvalidRequestResponse("CourseId is Missing. Cannot fetch Student Performance Vs Completion Data"),
		              ExecutionStatus.FAILED);
		    }
	    ...
	    List<String> userList = new ArrayList<>();
    	        ...
    	        if (classTotalCount != null) {
	    			...
	    			if (!studClass.isEmpty()) {
		    			...
		    			classPerfList = Base.findAll(AJEntityBaseReports.SELECT_ALL_STUDENT_CLASS_PERFORMANCE_COMPLETION, classId,
