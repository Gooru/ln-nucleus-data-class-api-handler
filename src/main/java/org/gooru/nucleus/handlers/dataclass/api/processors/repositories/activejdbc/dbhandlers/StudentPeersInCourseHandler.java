...
public class StudentPeersInCourseHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    List<Map> CoursePeerMap = Base.findAll(AJEntityBaseReports.GET_PEERS_COUNT_IN_COURSE, classId,
        this.context.userIdFromSession(), courseId);
    if (!CoursePeerMap.isEmpty()) {
      CoursePeerMap.forEach(m -> {
        ...
        StudentPeerArray.add(new JsonObject()
            .put(AJEntityBaseReports.ATTR_UNIT_ID,
