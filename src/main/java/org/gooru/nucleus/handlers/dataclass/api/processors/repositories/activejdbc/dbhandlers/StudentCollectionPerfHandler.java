	...
	public ExecutionResult<MessageResponse> executeRequest() {
		...
		for (String userID : userIds) {
	        ...
	        if (!StringUtil.isNullOrEmpty(classId) && !StringUtil.isNullOrEmpty(courseId) && !StringUtil.isNullOrEmpty(unitId) && !StringUtil.isNullOrEmpty(lessonId)) {
	          collectionMaximumScore = Base.findAll(AJEntityBaseReports.SELECT_COLLECTION_MAX_SCORE, classId,courseId,unitId,lessonId,collectionId, userID);
	        }else{
	          collectionMaximumScore = Base.findAll(AJEntityBaseReports.SELECT_COLLECTION_MAX_SCORE_, collectionId, userID);
	        }
	        ...
	        if (!StringUtil.isNullOrEmpty(classId) && !StringUtil.isNullOrEmpty(courseId) && !StringUtil.isNullOrEmpty(unitId) && !StringUtil.isNullOrEmpty(lessonId)) {
	          lastAccessedTime = Base.findAll(AJEntityBaseReports.SELECT_COLLECTION_LAST_ACCESSED_TIME, classId,courseId,unitId,lessonId,collectionId, userID);
	        }else{
	          lastAccessedTime = Base.findAll(AJEntityBaseReports.SELECT_CLASS_COLLECTION_LAST_ACCESSED_TIME, collectionId, userID);
	        }
	        ...
	        if (!StringUtil.isNullOrEmpty(classId) && !StringUtil.isNullOrEmpty(courseId) && !StringUtil.isNullOrEmpty(unitId) && !StringUtil.isNullOrEmpty(lessonId)) {
	          collectionData = Base.findAll(AJEntityBaseReports.SELECT_COLLECTION_AGG_DATA, classId,courseId,unitId,lessonId,collectionId, userID);
	        }else{
	          collectionData = Base.findAll(AJEntityBaseReports.SELECT_COLLECTION_AGG_DATA_,collectionId, userID);
	        }
	        if (!collectionData.isEmpty()) {
	          LOGGER.debug("Collection Attributes obtained");
	          collectionData.forEach(m -> {
	            JsonObject collectionDataObj = ValueMapper.map(ResponseAttributeIdentifier.getSessionCollectionAttributesMap(), m);
	            ...
	            collectionDataObj.put(EventConstants.RESOURCE_TYPE, m.get(AJEntityBaseReports.COLLECTION_TYPE).toString());
	            collectionDataObj.put(JsonConstants.SCORE, m.get(AJEntityBaseReports.SCORE) != null ? 
	            ...
	            int reaction=0;
	              ...
	              if (!StringUtil.isNullOrEmpty(classId) && !StringUtil.isNullOrEmpty(courseId) && !StringUtil.isNullOrEmpty(unitId) && !StringUtil.isNullOrEmpty(lessonId)) {
	               collectionScore = Base.firstCell(AJEntityBaseReports.SELECT_COLLECTION_AGG_SCORE, classId,courseId,unitId,lessonId,collectionId, userID);
	              }else{
	               collectionScore = Base.firstCell(AJEntityBaseReports.SELECT_COLLECTION_AGG_SCORE_,collectionId, userID);
	              }
	            ...
	            if (!StringUtil.isNullOrEmpty(classId) && !StringUtil.isNullOrEmpty(courseId) && !StringUtil.isNullOrEmpty(unitId) && !StringUtil.isNullOrEmpty(lessonId)) {
	              collectionReaction = Base.firstCell(AJEntityBaseReports.SELECT_COLLECTION_AGG_REACTION, classId,courseId,unitId,lessonId,collectionId, userID);
	            }else{
	              collectionReaction = Base.firstCell(AJEntityBaseReports.SELECT_COLLECTION_AGG_REACTION_,collectionId, userID);
	            }
