...
public class AJEntityContent extends Model {
  ...
  public static final String GET_CLASS_TITLE_CODE =
      "SELECT title,class_code FROM content WHERE id = ?";

  public static final String GET_TTITLE_TAXONOMY =
      "SELECT title,taxonomy FROM content WHERE id = ?";
