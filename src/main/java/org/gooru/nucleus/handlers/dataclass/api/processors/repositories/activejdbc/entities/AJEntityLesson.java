...
public class AJEntityLesson extends Model {
    ...
    public static final String FETCH_LESSON = "select l.unit_id, u.title as unitTitle, l.lesson_id, l.title as lessonTitle from lesson l inner join unit u on l.unit_id = u.unit_id where l.lesson_id = ?::uuid and l.course_id = ?::uuid and u.is_deleted = false and l.is_deleted = false";
