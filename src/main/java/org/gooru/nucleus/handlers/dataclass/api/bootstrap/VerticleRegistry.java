...
public class VerticleRegistry implements Iterable<String> {
  ...
  private static final String AUTH_VERTICLE = "org.gooru.nucleus.handlers.dataclass.api.bootstrap.AuthVerticle";

  private static final String CLASS_DATA_REPORT_VERTICLE = "org.gooru.nucleus.handlers.dataclass.api.bootstrap.DataClassReadApiVerticle";
