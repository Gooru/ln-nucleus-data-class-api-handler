...
public class IndLearnerAssessmentSessionsHandler implements DBHandler {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(IndLearnerAssessmentSessionsHandler.class);
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (!StringUtil.isNullOrEmpty(courseId) && !StringUtil.isNullOrEmpty(unitId)
        && !StringUtil.isNullOrEmpty(
            ...
            lessonId)) {
      distinctSessionsList = Base.findAll(AJEntityBaseReports.GET_IL_SESSIONS_FOR_COLLID, courseId,
          unitId, lessonId, this.collectionId, EventConstants.ASSESSMENT, userId);
    } else {
      // Currently, data for Assessments at the IL Landing page should be inclusive of CUL and
