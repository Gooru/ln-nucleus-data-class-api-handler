...
public class StudCAAssessmentSessionPerfHandler implements DBHandler {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(StudCAAssessmentSessionPerfHandler.class);
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    ...
    if (userId == null
        || (userId != null && !context.userIdFromSession().equalsIgnoreCase(userId))) {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    LazyList<AJEntityDailyClassActivity> dcaAssessmentPerf = AJEntityDailyClassActivity.findBySQL(
        AJEntityDailyClassActivity.SELECT_ASSESSMENT_PERF_FOR_SESSION_ID, context.sessionId(),
        userId, AJEntityDailyClassActivity.ATTR_CP_EVENTNAME,
    ...
    if (dcaAssessmentPerf != null && !dcaAssessmentPerf.isEmpty()) {
      ...
      Object assessmentReactionObject =
          Base.firstCell(AJEntityDailyClassActivity.SELECT_ASSESSMENT_REACTION_FOR_SESSION_ID,
      ...
      assessmentData.put(JsonConstants.SCORE,
          dcaAssessmentPerfModel.get(AJEntityDailyClassActivity.SCORE) != null
              ? Math.round(Double
                  .valueOf(dcaAssessmentPerfModel.get(AJEntityDailyClassActivity.SCORE).toString()))
              : null);
      ...
      List<Map> assessmentQuestionsKPI =
          Base.findAll(AJEntityDailyClassActivity.SELECT_ASSESSMENT_QUESTION_FOR_SESSION_ID,
              context.sessionId(), userId, AJEntityDailyClassActivity.ATTR_CRP_EVENTNAME);
      ...
      if (!assessmentQuestionsKPI.isEmpty()) {
        for (Map questions : assessmentQuestionsKPI) {
          ...
          Object reactionObj = Base.firstCell(
              AJEntityDailyClassActivity.SELECT_ASSESSMENT_RESOURCE_REACTION_FOR_SESSION_ID,
              context.sessionId(), userId,
          ...
          if (qnData.getString(EventConstants.QUESTION_TYPE)
            ...
            Object isGradedObj =
                Base.firstCell(AJEntityDailyClassActivity.GET_OE_QUE_GRADE_STATUS_FOR_SESSION_ID,
                    context.sessionId(), userId,
                    questions.get(AJEntityDailyClassActivity.RESOURCE_ID).toString());
