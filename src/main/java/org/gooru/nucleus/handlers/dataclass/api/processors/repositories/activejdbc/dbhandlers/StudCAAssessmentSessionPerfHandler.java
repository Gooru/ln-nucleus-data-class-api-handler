...
public class StudCAAssessmentSessionPerfHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        ...
        LazyList<AJEntityDailyClassActivity> dcaAssessmentPerf =
            AJEntityDailyClassActivity.findBySQL(AJEntityDailyClassActivity.SELECT_ASSESSMENT_PERF_FOR_SESSION_ID, context.sessionId(), AJEntityDailyClassActivity.ATTR_CP_EVENTNAME);
        if (dcaAssessmentPerf != null && !dcaAssessmentPerf.isEmpty()) {
            ...
            List<Map> assessmentQuestionsKPI =
                Base.findAll(AJEntityDailyClassActivity.SELECT_ASSESSMENT_QUESTION_FOR_SESSION_ID, context.sessionId(), AJEntityDailyClassActivity.ATTR_CRP_EVENTNAME);
