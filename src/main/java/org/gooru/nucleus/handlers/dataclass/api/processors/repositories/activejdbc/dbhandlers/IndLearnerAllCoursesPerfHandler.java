    	      ...
    	      coursePerfData.forEach(courseData -> {
    	        ...
    	        if (!cScoreCompletion.isEmpty()) {
    	          cScoreCompletion.forEach(scoreKPI -> {
    	            ...
    	            courseKPI.put(AJEntityBaseReports.ATTR_SCORE, scoreKPI.get(AJEntityBaseReports.ATTR_SCORE) == null ? null : Math.round(Double.valueOf(scoreKPI.get(AJEntityBaseReports.ATTR_SCORE).toString())));
    	          });
    	        } else {
