        ...
        if (!assessmentKpi.isEmpty()) {
          assessmentKpi.forEach(m -> {
            ...
            completedCountMap.forEach(scoreCompletonMap -> {
              ...
              unitData.put(AJEntityBaseReports.ATTR_SCORE, scoreCompletonMap.get(AJEntityBaseReports.ATTR_SCORE).toString() != null ? Math.round(Double.valueOf(scoreCompletonMap.get(AJEntityBaseReports.ATTR_SCORE).toString())) : null);
              LOGGER.debug("UnitID : {} - UserID : {} - Score : {}", unitId, userID,
                      AJEntityBaseReports.ATTR_SCORE, scoreCompletonMap.get(AJEntityBaseReports.ATTR_SCORE).toString() != null ? Math.round(Double.valueOf(scoreCompletonMap.get(AJEntityBaseReports.ATTR_SCORE).toString())) : null);
