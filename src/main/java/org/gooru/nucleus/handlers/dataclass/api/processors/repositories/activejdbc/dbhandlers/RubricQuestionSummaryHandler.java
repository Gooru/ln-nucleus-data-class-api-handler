...
public class RubricQuestionSummaryHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    List<Map> summaryMap = Base.findAll(AJEntityRubricGrading.GET_RUBRIC_GRADE_FOR_QUESTION,
        context.classId(), context.courseId(), context.collectionId(), context.questionId(),
