...
public class AJEntityClassCollectionCount extends Model {
  ...
  public static final String GET_CLASS_ASSESSMENT_COUNT = "SELECT SUM(assessment_count) as totalCount FROM class_collection_count WHERE course_id = ? GROUP BY course_id";
