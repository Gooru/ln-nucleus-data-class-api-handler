...
public final class EventConstants {
  ...
  public static final String COLLECTION_TABLE_FIELDS =
      "contentId,gooruOid,collectionType,grade,goals,ideas,performanceTasks,language,keyPoints,notes,languageObjective,network,mailNotification,buildTypeId,narrationLink,estimatedTime";
  ...
  public static final String INDEX_EVENTS =
      ".*collection.play.*|.*collection.resource.play.*|.*resource.play.*|.*reaction.create.*|.*item.rate.*|.*item.flag.*|.*item.create.*";
  ...
  public static final String RAW_DATA_UPDATE_EVENTS =
      "item.create|classpage.user.add|classpage.user.remove|item.delete|class.item.delete";
  ...
  public static final Pattern PLAY_EVENTS_PATTERN =
      Pattern.compile("collection.play|collection.resource.play|reaction.create|resource.play");
  ...
  public static final String VIEW_CALC_EVENTS =
      "collection.play|collection.resource.play|resource.play";

  public static final String CONTENT_FORMATS =
      "course|unit|lesson|collection|assessment|resource|question";

  public static final String COLLECTION_FORMATS = "course|unit|lesson|collection|assessment";

  public static final Pattern COLLECTION_TYPES =
      Pattern.compile("collection|assessment|assessment/url");

  public static final Pattern RESOURCE_FORMATS_PATTERN = Pattern.compile("resource|questions");

  public static final Pattern RECOMPUTATION_EVENTS_PATTERN =
      Pattern.compile("item.delete|item.move|item.remove");
  ...
  public static final String RESOURCE_USED_USER_VALIDATION =
      "C:count~C:user~E:parentSharing~E:mode|C:count~C:user~E:mode";
