...
public class IndependentLearnerIndependentAssessmentPerfHandler implements DBHandler {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(IndependentLearnerIndependentAssessmentPerfHandler.class);
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    for (String userID : userIds) {
      ...
      studentLatestAttempt =
          Base.findAll(AJEntityBaseReports.GET_INDEPENDENT_LEARNER_LATEST_ASS_COMPLETED_SESSION_ID,
