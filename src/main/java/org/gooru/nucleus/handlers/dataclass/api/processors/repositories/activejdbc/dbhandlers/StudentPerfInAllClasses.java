    	      ...
    	      classPerfData.forEach(classData -> {
    	        ...
    	        if (!classScoreCompletion.isEmpty()) {
    	          classScoreCompletion.forEach(scoreKPI -> {
    	            ...
    	            classKPI.put(AJEntityBaseReports.ATTR_SCORE, Double.valueOf(scoreKPI.get(AJEntityBaseReports.ATTR_SCORE).toString()));
    	          });
    	        }
	    	...
	    	if (!classPerfData.isEmpty()) { 
  	    	...
  	    	if (!classPerfList.isEmpty()) { 
	    		classPerfList.forEach(scoData -> {
    	            ...
    	            classKPI.put(AJEntityBaseReports.ATTR_SCORE, Double.valueOf(scoData.get(AJEntityBaseReports.ATTR_SCORE).toString()));
	    	});   
  	    	}
