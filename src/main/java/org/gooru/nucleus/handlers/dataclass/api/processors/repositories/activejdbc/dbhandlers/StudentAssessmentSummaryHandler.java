...
public class StudentAssessmentSummaryHandler implements DBHandler {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(StudentAssessmentSummaryHandler.class);
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    if (context.getUserIdFromRequest() == null
      ...
      Object classID = Base.firstCell(AJEntityBaseReports.SELECT_CLASS_BY_SESSION_ID,
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (!StringUtil.isNullOrEmpty(sessionId)) {
      List<Map> assessmentKPI =
          Base.findAll(AJEntityBaseReports.SELECT_ASSESSMENT_FOREACH_COLLID_AND_SESSION_ID,
              context.collectionId(), sessionId, AJEntityBaseReports.ATTR_CP_EVENTNAME);
      Object assessmentReactionObject = Base.firstCell(
          AJEntityBaseReports.SELECT_ASSESSMENT_REACTION, context.collectionId(), sessionId);
