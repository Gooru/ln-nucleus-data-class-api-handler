...
public class AJEntityUserNavigationPaths extends Model {
    ...
    public static AJEntityUserNavigationPaths fetchSystemSuggestedContent(String collId) throws Throwable {
        ...
        try {
            ...
            LazyList<AJEntityUserNavigationPaths> results = AJEntityUserNavigationPaths.find("suggested_content_id = ?::uuid", collId);
