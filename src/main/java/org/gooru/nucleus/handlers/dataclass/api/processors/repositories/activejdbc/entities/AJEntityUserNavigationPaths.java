...
public class AJEntityUserNavigationPaths extends Model {
    ...
    private static final String FETCH_SYSTEM_SUGGESTION = "suggested_content_id = ?::uuid and ctx_class_id = ?::uuid and ctx_course_id = ?::uuid and ctx_lesson_id = ?::uuid";

    public static AJEntityUserNavigationPaths fetchSystemSuggestedContent(String collId, String classId, String courseId, String lessonId) throws Throwable {
        ...
        try {
            ...
            LazyList<AJEntityUserNavigationPaths> results = AJEntityUserNavigationPaths.find(FETCH_SYSTEM_SUGGESTION, collId, classId, courseId, lessonId);
